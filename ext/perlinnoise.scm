...
(define-cproc perlinnoise-2d(x::<float> y::<float> persistence::<float> octaves::<float>)
  (result (Scm_MakeFlonum (perlinnoise_2d x y persistence octaves))))
)
